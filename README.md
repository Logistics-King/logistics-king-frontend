...
`화주 > 계약 요청 > 계약 요청 등록`에서 대리점에 보낼 계약 요청을 등록합니다.
배송 물품 라인은 여러 개 추가할 수 있습니다.
단건 계약은 회수/배송 희망 기간을 입력하고, 정기 계약은 주간/월간 회수 조건을 입력합니다.
...
`화주 > 계약 요청 > 계약 요청 조회`에서 진행 상태를 확인합니다.
...
제출 상태의 제안은 배송 물품 라인별 단가와 조건을 수정하거나 철회할 수 있습니다.
...
| 화주 | 계약 요청 등록 | `/vendor/contract-requests/new` |
| 화주 | 계약 요청 조회 | `/vendor/contract-requests` |
